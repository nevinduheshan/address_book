<x-layout>
    <div class="container mx-auto py-4">
        ...
        <form method="POST" action="{{ route('projects.store') }}">
            ...
            <!-- Project Description -->
            <div class="mb-4">
                <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Project
                    Description</label>
            ...
            <div class="mb-4">
                <label for="customers" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
                    Customers</label>

                <!-- The Select Input with Multiple Option -->
                <select id="customers" name="customers[]" multiple placeholder="Select a customer..." autocomplete="off"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
